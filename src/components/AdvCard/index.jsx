...
let AdvCard = () => {
    let infos = [
        ...
        {image:personal, title: 'Personalização aprimorada', info: 'Permite adaptar a mensagem e o design de acordo com a audiência e a oferta, proporcionando uma experiência mais personalizada, o que pode resultar em maior engajamento e conversões.' },
